...
public class AssembleTransactionDemo {
	...
	public void testDeploy() throws Exception {
		...
		TransactionResponse response = bcosClientWrapper.transactionProcessor.deployByContractLoader("HelloWorld", new ArrayList<>());
	...
	public void testABIInfo() throws NoSuchTransactionFileException {
		...
		List<ABIDefinition> abilst = bcosClientWrapper.transactionProcessor.getContractLoader()
				.getFunctionABIListByContractName(contractName);
		for (ABIDefinition de : abilst) {
			System.out.println(
					"name:" + de.getName() + ",type:" + de.getType() + ",mutability:" + de.getStateMutability());
		}
	}
	...
	public void testCall() throws TransactionBaseException, ABICodecException {
		...
		CallResponse callResponse = bcosClientWrapper.transactionProcessor.sendCallByContractLoader(contractName, contractAddress, "get",
				new ArrayList<>());
	...
	public void testTx() throws ABICodecException, TransactionBaseException {
		...
		params.add("my test");
		TransactionResponse txResp = bcosClientWrapper.transactionProcessor.sendTransactionAndGetResponseByContractLoader(contractName,
				contractAddress, "set", params);
