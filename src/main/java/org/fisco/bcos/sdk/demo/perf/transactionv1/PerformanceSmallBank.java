...
import org.fisco.bcos.sdk.demo.contract.transactionv1.SmallBank;
...
public class PerformanceSmallBank {
    ...
    public static void Usage() {
        ...
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.fisco.bcos.sdk.demo.perf.transactionv1.PerformanceSmallBank [groupId] [add] [count] [qps] [file] [parallel(true/false)].");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.fisco.bcos.sdk.demo.perf.transactionv1.PerformanceSmallBank [groupId] [transfer] [count] [qps] [file] [parallel(true/false)].");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.fisco.bcos.sdk.demo.perf.transactionv1.PerformanceSmallBank [groupId] [save] [count] [qps] [file] [parallel(true/false)].");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.fisco.bcos.sdk.demo.perf.transactionv1.PerformanceSmallBank [groupId] [generate] [count] [qps] [file] [parallel(true/false)].");
    }
    ...
    public static void start(
        ...
        org.fisco.bcos.sdk.demo.contract.transactionv1.SmallBank smallBank;

        final Random random = new Random();
        random.setSeed(System.currentTimeMillis());

        if (Objects.equals(command, "add")) {
            smallBank = SmallBank.deploy(client, client.getCryptoSuite().getCryptoKeyPair());
            ...
            smallBank = SmallBank.load(dagUserInfo.getContractAddr(), client);
            smallBank.setEnableDAG(enableParallel);
        }
        long txtotal = count;
